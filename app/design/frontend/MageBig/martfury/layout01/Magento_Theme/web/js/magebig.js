                ...
                $win.scrolled( function() {
                    ...
                    if (sType == 1) {
                        if (curWinTop > threshold && wh > 500 && curWinTop < lastScrollTop) {
                            ...
                            if (stickyActive) {
                                $stickyMenu.removeClass('').addClass('');
                                setTimeout(function () {
        ...
        _stickyAddCart: function () {
            ...
            if ($stickyAddCart.length > 0) {
                ...
                $win.scrolled( function() {
                    ...
                    if (curWinTop > threshold && wh > 500) {
                        if (!stickyActive) {
                            $sAddCartChild.addClass('');
                            $stickyAddCart.addClass('');
                            stickyActive = true;
                        }
                        ...
                        if (stickyActive) {
                            $sAddCartChild.removeClass('').addClass('');
                            setTimeout(function () {
                               $sAddCartChild.removeClass('');
                               $stickyAddCart.removeClass('');
                            }, 100);
                            stickyActive = false;
                        }
                    }
