define([
    ...
    return Component.extend({
        defaults: {
            ...
            localStorageVendor: $.initNamespaceStorage('ajaxsearchvendor').localStorageVendor,
            searchText: '',
            searchtype: '',
            lifetime: 60,
        ...
        loadData: function () {
            ...
            this.xhr = $.ajax({
                ...
                dataType: "json",
                url: this.url,
                data: {q: this.searchText, st:searchtype},
                beforeSend: function () {
                    self.spinnerShow();
                },
                success: $.proxy(function (response) {
                    if(response.vendor){
                        ...
                        if (response.result[0].size) {
                            self.saveToLocalStorageVendor(response, self.searchText);
                        }
    
                        self.showPopupVendor(response);
        ...
        parseData: function (response) {
            ...
            console.log('---3rd parseData---Newjs');
            console.log(response);
        ...
        getResponseData: function (response, code) {
            ...
            console.log('---? getResponseData---Newjs'+ code);
            console.log(response);
            ...
            console.log('---? getResponse data after loop---');
            console.log(data);
        ...
        setSuggested: function (suggestedData) {
            ...
            console.log('---4th setSuggested---Newjs');
        ...
        setProducts: function (productsData) {
            ...
            console.log('---5th setProducts---Newjs');
        ...
        loadFromLocalStorage: function (queryText) {
            ...
            console.log('---data print products ---Newjs');
            console.log(data);
            this.parseData(data);
        ...
        loadFromLocalStorageVendor: function (responseData) {
            // if (!this.localStorageVendor) {
            //     console.log(this.localStorageVendor);
            //     console.log('---no error ---');
            // }

            // var hash = this._hash(queryText);
            // var data = this.localStorageVendor.get(hash);

            // if (!data) {
            //     console.log('---data nhi hy ---');
            //     return false;
            // }
            // console.log('---data print ---');
            // console.log(data);

            console.log('---2nd loadFromLocalStorageVendor---Newjs');
        ...
        saveToLocalStorageVendor: function (data, queryText) {
            if (!this.localStorageVendor) {
                return;
            }

            var hash = this._hash(queryText);
            this.localStorageVendor.set(hash, data);
        },
        ...
        showPopupVendor: function (response) {
            var self = this,
                hasStorage,
                searchField = $(self.inputSelector),
                searchText = searchField.val().trim();
            ...
            console.log('---1st showPopupVendor---Newjs');
            console.log(response);

            hasStorage = this.loadFromLocalStorageVendor(response);
            self.loadPopup(true);
            // if (!hasStorage) {
            //     self.searchText = searchText;
            //     self.loadData();
