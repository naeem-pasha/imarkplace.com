    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $this->_eventManager->dispatch(
                'takaful_prepare_save',
                ['takaful' => $model, 'request' => $this->getRequest()]
            );
            ...
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    return $resultRedirect->setPath('*/*/edit', ['takaful_id' => $model->getId(), '_current' => true]);
                }
            ...
            return $resultRedirect->setPath('*/*/edit', ['takaful_id' => $this->getRequest()->getParam('takaful_id')]);
        }
        return $resultRedirect->setPath('*/*/');
    }
}
