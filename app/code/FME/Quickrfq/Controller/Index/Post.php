...
//createAttachment();
		...
		/////////////Email function comment due to robots attacks/////////
...
?>
                 <script type="text/javascript">
                   window.location.assign('https://members.almeezangroup.com/NormalOnlineAccount.aspx?at=2GQ8S7nYBMueSOaNmqdNQQ==');
			// window.open('https://members.almeezangroup.com/NormalOnlineAccount.aspx?at=2GQ8S7nYBMueSOaNmqdNQQ==', '_blank');
                   // window.location.replace("/quickrfq");
                </script>
<?php                        
