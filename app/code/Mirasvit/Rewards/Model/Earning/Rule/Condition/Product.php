...
class Product extends \Magento\Rule\Model\Condition\Product\AbstractProduct
{
    ...
    /**
     * @var EavModel\ResourceModel\Entity\Attribute\Set\CollectionFactory
     */
    ...
    public function getValueAfterElementHtml()
    {
        ...
        if (!empty($image)) {
            $html = '<a href="javascript:void(0)" class="rule-chooser-trigger">
                <img alt="imarkplace" src="'.$image.'" alt="" class="v-middle rule-chooser-trigger" title="'
                .__('Open Chooser').'" /></a>';
        }
    ...
    public function validate(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $order = $object->getCustomerOrder();
        if ($object instanceof \Magento\Customer\Model\Customer && $order) {
        ...
        if ($object instanceof \Magento\Customer\Model\Customer && $product) {
        ...
        switch ($attrCode) {
            case 'category_ids':
                ...
                //we should check if category collection exists for the Product instead of Magento shipping Tracking Number
                if ($object->getCategoryCollection()) {
            ...
            case 'special_price':
                ...
                return $this->validateAttribute((float)$object->getSpecialPrice());
                break;
