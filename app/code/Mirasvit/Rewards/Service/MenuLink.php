...
class MenuLink
{
    ...
    {
        return $this->config->getCustomerGroups();
    }
    ...
    public function isShowMenuForCurrentCustomer($customer)
    {
        ...
        $isAllCustomerGroupsAllowed = in_array('all', explode(',', $this->getCustomerGroups()));
        $isShowForCustomer          = in_array($customerGroup, explode(",", $this->getCustomerGroups()));
