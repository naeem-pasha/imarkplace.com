...
namespace Mirasvit\RewardsAdminUi\Block\Adminhtml\Transaction;

use Mirasvit\Rewards\Model\Config\Source\Customer\Group as GroupOptions;
use Magento\Store\Model\StoreManagerInterface;

/**
 * Uses in transaction export
 */
    ...
    protected function _prepareColumns()
    {
        ...
        if ($this->_isExport) {
            ...
            $this->addColumn('amount', [
                    ...
                    'filter_index' => 'main_table.amount',
                    'type'         => 'currency',
                    'renderer'     => '\Mirasvit\RewardsAdminUi\Block\Adminhtml\Grid\Renderer\Balance',
                ]
            );
        }
