...
class Export extends \Mirasvit\RewardsAdminUi\Controller\Adminhtml\Transaction
{
    /**
    ...
    public function execute()
    {
        ...
        /** @var \Mirasvit\RewardsAdminUi\Block\Adminhtml\Transaction\Grid $grid */
        $grid = $resultPage->getLayout()
            ->createBlock('Mirasvit\RewardsAdminUi\Block\Adminhtml\Transaction\Grid', 'transaction.grid');
