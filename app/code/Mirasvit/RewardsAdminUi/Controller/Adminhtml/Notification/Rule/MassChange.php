...
class MassChange extends \Mirasvit\RewardsAdminUi\Controller\Adminhtml\Notification\Rule
{
    private $filter;
        ...
        if ($ids && is_array($ids)) {
            try {
                ...
                foreach ($ids as $id) {
                    ...
                    $notificationRule = $this->notificationRuleFactory->create()->load($id);
                    $notificationRule->setIsActive($isActive);
