 ...
 */
namespace Imark\RequestForQuote\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const URL_PATH_EDIT = 'requestforquote/index/edit';
    const URL_PATH_DELETE = 'requestforquote/index/delete';
