...
class Post extends \Imark\RequestForQuote\Controller\Index
{
...
/*Save Data Start*/
                ...
                $model = $this->_objectManager->create('Imark\RequestForQuote\Model\Quickrfq');
                $model->setData($post);
                ...
                $this->_redirect('maintenance/mechanical.html');
                return;
            } catch (\Exception $e) {
