    ...
    public function render(AbstractElement $element)
    {
        ...
        foreach ($lists as $listKey => $lable) {
            ...
            foreach ($products as $productKey => $product) {
                ...
                $html .= '<tr>';
                $html .= '<td><a target="_blank" rel="noopener" href="' . $this->escapeHtml($product->product_url) . '">' . $this->escapeHtml($product->product_name) . '</a></td>';
                $html .= '<td>' . $this->escapeHtml($version) . '</td>';
                $html .= '<td><a target="_blank" rel="noopener" href="' . $this->escapeHtml($product->change_log_url) . '">' . $this->escapeHtml(__('Change Log')) . '</a></td>';
                $html .= '<td><a target="_blank" rel="noopener" href="' . $this->escapeHtml($product->documentation_url) . '">'. $this->escapeHtml(__('User Guide')). '</a></td>';
                $html .= '</tr>';
            }
