...
class Summary extends \Magento\Customer\Controller\AbstractAccount
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
        ...
        if ($this->marketplaceHelper->isSeller()) {
            ...
            if ($this->marketplaceHelper->getIsSeparatePanel()) {
                $resultPage->addHandle('mpaffiliate_marketplace_summary_layout2');
            }
            $resultPage->getConfig()->getTitle()->set(__('Affiliate Summary'));
            return $resultPage;
        } else {
