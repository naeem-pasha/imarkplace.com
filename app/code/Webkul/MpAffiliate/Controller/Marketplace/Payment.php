...
class Payment extends \Magento\Customer\Controller\AbstractAccount
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
        ...
        if ($this->marketplaceHelper->isSeller()) {
            ...
            if ($this->marketplaceHelper->getIsSeparatePanel()) {
                $resultPage->addHandle('mpaffiliate_marketplace_payment_layout2');
            }
            $resultPage->getConfig()->getTitle()->set(__('Affiliate Payment'));
            return $resultPage;
        } else {
