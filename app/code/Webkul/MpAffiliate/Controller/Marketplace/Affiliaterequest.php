<?php
/**
 * Webkul MpAffiliate Marketplace Affiliaterequest controller.
 * @category  Webkul
...
class Affiliaterequest extends \Magento\Customer\Controller\AbstractAccount
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
        ...
        if ($this->marketplaceHelper->isSeller()) {
            ...
            if ($this->marketplaceHelper->getIsSeparatePanel()) {
                $resultPage->addHandle('mpaffiliate_marketplace_affiliaterequest_layout2');
            }
            $resultPage->getConfig()->getTitle()->set(__('Marketplace Affiliate list'));
            return $resultPage;
        } else {
