...
namespace Webkul\MpAffiliate\Plugin;
 ...
 */
    ...
    public function saveInSession($data)
    {
        ...
        if (empty($totalAffIds) || $totalAffIds=="" || $totalAffIds==null) {
        ...
        if (!empty($totalAffIds)) {
            ...
            if ($status) {
                ...
                $this->customerSession->setAffIds($totalAffIds);
                $this->checkoutSession->setAffIds($totalAffIds);
                $this->coreSession->setAffIds($totalAffIds);
