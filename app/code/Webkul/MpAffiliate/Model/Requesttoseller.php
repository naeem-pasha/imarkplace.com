...
use Webkul\MpAffiliate\Api\Data\RequestInterface;
use Magento\Framework\DataObject\IdentityInterface;

class Requesttoseller extends \Magento\Framework\Model\AbstractModel implements RequestInterface
{
    /**
     * CMS page cache tag.
     */
    const CACHE_TAG = 'mp_affiliate_request';

    /**
     * @var string
     */
    protected $_cacheTag = 'mp_affiliate_request';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mp_affiliate_request';
    ...
    {
        $this->_init(\Webkul\MpAffiliate\Model\ResourceModel\Requesttoseller::class);
    }
