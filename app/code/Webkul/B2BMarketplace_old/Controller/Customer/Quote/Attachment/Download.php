...
namespace Webkul\B2BMarketplace\Controller\Customer\Quote\Attachment;
...
class Download extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            if (!$this->b2bQuoteHelper->isValidQuote($quoteAttachment->getQuoteId(), B2bQuoteHelper::TYPE_BUYER)) {
