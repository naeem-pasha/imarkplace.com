...
namespace Webkul\B2BMarketplace\Controller\Customer\Attachment;
...
class Download extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            if (!$this->isValidCustomerMessage($attachment->getMsgId())) {
     ...
     * @return bool
     */
    private function isValidCustomerMessage($id)
    {
        ...
        if ($model->getId()) {
            if ($model->getSenderId() == $customerId || $model->getReceiverId() == $customerId) {
                return true;
            }
        }
        return false;
