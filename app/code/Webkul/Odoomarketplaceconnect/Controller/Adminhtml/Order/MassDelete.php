...
use Webkul\Odoomarketplaceconnect\Model\ResourceModel\Order\CollectionFactory;
    ...
    public function execute()
    {
        try {
            $collection = $this->_objectManager
                ->create('Webkul\Odoomarketplaceconnect\Model\Order')
                ->getCollection();
            ;
            ...
            if ($collection->getSize() > 0) {
                ...
                $this->messageManager->addSuccess(__('Order mapping deleted succesfully.'));
            }
        } catch (\Exception $e) {
