<?php
/**
 * Webkul Odoomarketplaceconnect Product MassDisable Controller
 *
 * @Product   Webkul
...
/**
 * Webkul Odoomarketplaceconnect Product MassDisable Controller class
 */
    ...
    public function execute()
    {
        try {
            ...
            if ($collection->getSize() > 0) {
                ...
                $collection->save();
                $this->messageManager->addSuccess(__('Marketplace Seller(s) need sync disabled successfully.'));
            }
        } catch (\Exception $e) {
