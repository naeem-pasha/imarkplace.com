<?php
/**
 * Webkul Odoomarketplaceconnect Category MassDelete Controller
 *
 * @category  Webkul
...
/**
 * Webkul Odoomarketplaceconnect Category MassDelete Controller class
 */
    ...
    public function execute()
    {
        try {
            ...
            if ($collection->getSize() > 0) {
                ...
                $this->messageManager->addSuccess(__('The Website Category Mapping(s) have been deleted.'));
            }
        } catch (\Exception $e) {
