...
namespace Webkul\B2BMarketplace\Controller\Customer\Quote\Item\Attachment;
...
class Download extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            if (!$this->isValidCustomerQuoteItem($quoteId, $itemId)) {
    ...
    /**
     * Check if this is valid customer quote
     *
     * @param int $quoteId
     * @param int $itemId
     * @return bool
     */
    private function isValidCustomerQuoteItem($quoteId, $itemId)
    {
        $customerId = $this->b2bQuoteHelper->getCustomerId();
        $collection = $this->b2bQuoteHelper->getAllQuoteItems();
