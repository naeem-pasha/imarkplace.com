    ...
    public function execute()
    {
        ...
        try {
            ...
            if (!$validateResult['error']) {
                ...
                $cnic = $this->getRequest()->getParam("cnic_number");
                $company_no = $this->getRequest()->getParam("company_number");
                $categories = $this->getRequest()->getParam("store_categories");
                $customer->setCustomAttribute('cnic_number',$cnic);
                $customer->setCustomAttribute('company_number',$company_no);
                $customer->setCustomAttribute('store_categories',$categories);
