 ...
 */
namespace Webkul\MarketplaceLearningManagementSystem\Controller\Adminhtml\Content;
...
class UploadAssignment extends Action
{
    /**
    ...
    {
        try {
            $uploader = $this->uploaderFactory->create(['fileId' => 'import_file2']);
