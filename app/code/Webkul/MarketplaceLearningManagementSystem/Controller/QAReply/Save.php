...
class Save extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            if (isset($formData['qaThread'])) {
                
                $qaReplyModel->setQnaThread($formData['qaThread']);
            }
            if (isset($formData['qaId'])) {
                $qaReplyModel->setQaId($formData['qaId']);

                $qaRecordModel->load($formData['qaId']);
