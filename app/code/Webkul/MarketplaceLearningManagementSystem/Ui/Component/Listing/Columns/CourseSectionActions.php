...
class CourseSectionActions extends Column
{
                ...
                if (isset($item['entity_id'])) {
                    $item[$name]['reply'] = [
                        'callback' => [
                            [
                                'provider' =>
                                    'course_section_listing.course_section_listing.'.
                                    'course_section_modal.course_section_form_loader',
                                'target' => 'destroyInserted',
                            ],
                            [
                                'provider' =>
                                    'course_section_listing.course_section_listing.course_section_modal',
                                'target' => 'openModal',
                            ],
                            [
                                'provider' =>
