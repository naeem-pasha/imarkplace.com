...
class MpQAReplyActions extends Column
{
    /**
     * @var UrlInterface
     */
                ...
                if (isset($item['entity_id'])) {
                    $item[$name]['reply'] = [
                        'callback' => [
                            [
                                'provider' =>
                                    'mp_qa_reply_listing.mp_qa_reply_listing.qa_reply_modal.qa_reply_form_loader',
                                'target' => 'destroyInserted',
                            ],
                            [
                                'provider' =>
                                    'mp_qa_reply_listing.mp_qa_reply_listing.qa_reply_modal',
                                'target' => 'openModal',
                            ],
                            [
                                'provider' =>
