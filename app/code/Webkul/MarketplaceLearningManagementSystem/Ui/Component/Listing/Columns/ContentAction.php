...
class ContentAction extends Column
{
                ...
                if (isset($item['entity_id'])) {
                    $item[$name]['edit'] = [
                        'callback' => [
                            [
                                'provider' =>
                                    'course_content_listing.course_content_listing.'.
                                    'course_content_update_modal.update_course_content_form_loader',
                                'target' => 'destroyInserted',
                            ],
                            [
                                'provider' =>
                                    'course_content_listing.course_content_listing.course_content_update_modal',
                                'target' => 'openModal',
                            ],
                            [
                                'provider' =>
