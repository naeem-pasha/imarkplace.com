...
class ProductSaveAfterObserver implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($proId && $route == 'product') {
            ...
            # reassigning the categories as it was not able to save categories after add/remove operation
            # during product save. Due to which categories in Odoo mismatched with that of Magento product.
            $categoryLinkInterface = $helper->getModel(\Magento\Catalog\Api\CategoryLinkManagementInterface::class);
            $categoryLinkInterface->assignProductToCategories($sku, $product->getCategoryIds());
