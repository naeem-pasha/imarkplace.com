...
use  Webkul\Odoomagentoconnect\Model\ResourceModel\Category;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    {
        $mageCategory = $this->_categoryModel->getMageCategoryArray();
        $odooCategory = $this->_categoryModel->getOdooCategoryArray();
