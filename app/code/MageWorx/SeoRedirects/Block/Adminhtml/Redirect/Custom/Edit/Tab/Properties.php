    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        //From GMT to TimeZone
        if (!empty($redirectData['start_at'])) {
            $redirectData['start_at_locale'] = $this->timezone->date($redirectData['start_at'])->format('Y-m-d H:i:s');
        }

        if (!empty($redirectData['finish_at'])) {
            $redirectData['finish_at_locale'] = $this->timezone->date($redirectData['finish_at'])->format('Y-m-d H:i:s');
        }
