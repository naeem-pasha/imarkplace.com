...
namespace MageWorx\SeoRedirects\Model\Redirect\DpRedirect;
...
class RedirectCreatorByDeletedProductUrl
{
    ...
    /**
     * ProductDeleteWizard constructor.
     *
     ...
     * @param ProductDeleteWizard $productDeleteWizard
     */
     ...
     */
    public function process($product, $currentUrlRewrites)
    {
