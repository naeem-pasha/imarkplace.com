...
class ConditionEnabled extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $comment = __(
            ...
            ['link' => '<a target="_blank" rel="noopener" href="' . $link . '">' . $linkText . '</a>']
        );
        ...
        $comment .= ' ' . __(
                ...
                [
                    'new'         => '<a target="_blank" rel="noopener" href="' . $linkToNew . '">' . $linkTextToNew . '</a>',
                    'used'        => '<a target="_blank" rel="noopener" href="' . $linkToUsed . '">' . $linkTextToUsed . '</a>',
                    'refurbished' => '<a target="_blank" rel="noopener" href="' . $linkToRefurbished . '">' . $linkTextToRefurbished . '</a>',
                    'damaged'     => '<a target="_blank" rel="noopener" href="' . $linkToDamaged . '">' . $linkTextToDamaged . '</a>'
                ]
            );
