...
class Duplicate extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('CMS Page Report / Duplicates'), __('CMS Page Report / Duplicates'));
        $resultPage->getConfig()->getTitle()->prepend(__('CMS Page Report / Duplicates'));
