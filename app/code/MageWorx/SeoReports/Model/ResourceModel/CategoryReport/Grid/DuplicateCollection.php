...
/**
 * Collection for displaying grid of category report duplicated rows
 */
class DuplicateCollection extends CategoryReportCollection implements SearchResultInterface
{
    /**
     ...
     *
     * @param \MageWorx\SeoReports\Model\Config\Category $reportConfig
