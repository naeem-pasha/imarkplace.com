...
class Index extends Action
{
    ...
    protected function setPageData()
    {
        ...
        $resultPage->addBreadcrumb(__('SEO Product Templates'), __('SEO Product Templates'));
        $resultPage->getConfig()->getTitle()->prepend(__('SEO Product Templates'));
        return $this;
    }
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu(
            'MageWorx_SeoXTemplates::templateproduct'
        )->_addBreadcrumb(
            __('Templates for Product'),
            __('Templates for Product')
        );
        return $this;
    }
