...
class Index extends Action
{
    ...
    protected function setPageData()
    {
        ...
        $resultPage->addBreadcrumb(__('SEO Category Templates'), __('SEO Category Templates'));
        $resultPage->getConfig()->getTitle()->prepend(__('SEO Category Templates'));
        return $this;
    }
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu(
            'MageWorx_SeoXTemplates::templatecategory'
        )->_addBreadcrumb(
