...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('MageWorx\SeoXTemplates\Model\Template\Product', 'MageWorx\SeoXTemplates\Model\ResourceModel\Template\Product');
    }
    ...
    {
        $this->getSelect()->where('main_table.is_single_store_mode = ?', (int)$isSingleStoreMode);
        return $this;
    }
