...
class Exclude extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $comment = __(
            ...
            [
                'linkProduct'  => '<a target="_blank" rel="noopener" href="' . $linkToProduct . '">' . __('Product') . '</a>',
                'linkCategory' => '<a target="_blank" rel="noopener" href="' . $linkToCategory . '">' . __('Category') . '</a>',
                'linkPage'     => '<a target="_blank" rel="noopener" href="' . $linkToPage . '">' . __('Page') . '</a>',
            ]
        );
