...
class Main extends \Magento\Widget\Block\Adminhtml\Widget\Options  implements TabInterface
{
    ...
    {
        $hrefBefore = '<a href="http://support.mageworx.com/extensions/seo_suite_pro_and_ultimate/how_to_add_keywords_for_creating_internal_links.html" target="_blank" rel="noopener">';
        $hrefAfter  = '</a>';
