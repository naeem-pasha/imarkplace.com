            ...
            $.each(config.options, function (index) {
                ...
                if (type === 0) {
                    ...
                    html += '<div class="' + optionClass + ' image" ' + attr +
                        ...
                        '<img alt="imarkplace" class="media-lazy lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" alt="" width="' + swatchImageWidth + '" height="' + swatchImageHeight + '" data-src="' + value + '">' +
                        '</span>' +
                        '</div>';
                } else if (type === 3) {
                    // Clear
