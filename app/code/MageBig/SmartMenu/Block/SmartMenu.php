    ...
    protected function _catMegaHtml($catInfo, $catLevel = 0, $outerClass = '', $childWrapClass = '')
    {
        ...
        if ($iconHtml = $catInfo->getData('smartmenu_cat_icon')) {
            ...
            if (strpos($iconImage, '/catalog/')) {
                ...
                $iconHtml = '<img alt="imarkplace" width="20" height="20" alt="' . $catInfo->getData('name') . '" src="' . $this->_mediaUrl . $iconImage . '">';
            } else {
                $iconHtml = '<img alt="imarkplace" width="20" height="20" alt="' . $catInfo->getData('name') . '" src="' . $this->_mediaUrl . 'catalog/category/' . $iconImage . '">';
            }
