...
class BrandFeatured extends \MageBig\Shopbybrand\Block\Widget\BrandAbstract
{
	protected $_template = 'widget/brand_sidebar.phtml';
	
    protected $_cacheTag = 'BRAND_SIDEBAR';
